  ...
  return (
    <div className="bg-gray-100 text-black" id="services">
      <div className="container max-w-navbar mx-auto w-full flex flex-col gap-8 py-8 px-0 lg:px-4 md:py-12 lg:py-16">
        <div className="w-full flex flex-col lg:flex-row items-center justify-between text-black gap-4">
          <div className="flex flex-col gap-5 items-center lg:items-start">
            <p className="lg:text-3xl text-lg font-bold text-center lg:text-left leading-5 p-2">
              Homenu
            </p>
          </div>
