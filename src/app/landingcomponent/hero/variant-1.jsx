    ...
    <>
      <div className="flex flex-col items-center justify-center text-center gap-24 relative md:pt-24 pt-12">
        <div className="md:w-[750px] w-[380px] gap-10 flex flex-col items-center">
          ...
          {!isExtension && (
            <div className="md:flex items-center md:space-y-0 space-y-2 md:space-x-2">
              <div className="text-2xl font-semibold">Start With</div>
              <Link
                href="/editor"
                className="bg-[#3A30BA] text-white rounded-md px-5 py-3 block"
              >
                Drag & Drop
              </Link>
              <Link
