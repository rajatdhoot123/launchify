const CommingSoon = () => {
  return (
    <section class="container mx-auto flex items-center flex-1 border border-gray-200 py-12 rounded-xl">
      <div class="flex flex-col w-full ">
        ...
        <p class="mt-8 text-center text-gray-700 dark:text-white text-md md:text-xl">
